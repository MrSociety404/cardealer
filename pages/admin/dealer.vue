<template>
  <div class="nuxt-box">
    <header>
      ...
      <vs-button circle size="large" @click="active=!active"><i class='bx bx-plus'></i> Nouveau vendeur</vs-button>
    </header>
    <main class="dealer">
      <vs-card 
      ...
      >
        ...
        <template #text>
          <p> Employé(e) depuis le {{new Date(dealer.joinAt).toLocaleDateString()}} </p>
        </template>
